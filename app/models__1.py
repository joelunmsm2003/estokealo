...
class Color(models.Model):
    nombre = models.CharField(max_length=1100, blank=True, null=True)
...
class Producto(models.Model):
    ...
    ba_os = models.IntegerField(db_column='ba\xf1os', blank=True, null=True)  # Field renamed to remove unsuitable characters.
